const rulesBlack = {
    ...
    ruleLeft() {
        ...
        for (let i = cellColumn - 1; i > 0; i--) {
            ...
            if (cellNextLeft.className.slice(11).trim() === 'cellBlackPiece') {
    ...
    ruleRight() {
        ...
        for (let i = cellColumn + 1; i < 9; i++) {
            ...
            //------------if white Piece -> turn over black piece ------------------//
            if (cellNextRight.className.slice(11).trim() === 'cellBlackPiece') {
    ...
    ruleUp() {
        ...
        for (let i = cellLine - 1; i > 0; i--) {
            ...
            //------------if white Piece -> turn over black piece ------------------//
            if (cellNextTop.className.slice(11).trim() === 'cellBlackPiece') {
